            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li><a data-toggle="tab" href="#mailbox"><i class="notika-icon notika-mail"></i>Data Pengguna</a>
                        </li>
                    ...
                    <div class="tab-content custom-menu-content">
                        <div id="Home" class="tab-pane in active notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                ...
                                <li><a href="index-4.html">Dashboard </a>
                                </li>
                        ...
                        <div id="mailbox" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                ...
                                <li><a href="add_user.php">Tambah</a>
                                </li>
                        ...
                        <div id="Tables" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                ...
                                <li><a href="variabel.php">Hasil Variabel</a>
                                </li>
                                <li><a href="variabel.php">Perhitungan Aritmatika</a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="footer-copy-right">
                        <p>Copyright © 2019 
. All rights reserved. Template by <a href="https://tniad.mil.id">TNI AD</a>.</p>
                    </div>
                </div>
            </div>
        </div>
